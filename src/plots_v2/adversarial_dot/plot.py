...
def plot_adversarial_dot_plot(
    ...
    fig, ax = plt.subplots(figsize=(8, max(3, n_eps * 0.9) + 1.0), dpi=150)
    ...
    ax.set_xticklabels([f"{x:.1f}" for x in np.arange(0.0, 1.1, 0.1)], fontsize=8)
    ...
    ax.set_title(attack.upper(), fontsize=11, pad=6)
