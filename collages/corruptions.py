...
CORRUPT_DIR = Path("data/imagenet_c")
SYNSET = "n04612504"  # n02509815
SEVERITY = 3
THUMB_SIZE = 100
GAP = 6
BG_COLOR = (245, 245, 245)

# Nowe ustawienia dla paska z różnymi poziomami severity
SEVERITIES = [1, 2, 3, 4, 5]
SEVERITY_CORRUPTION = "gaussian_noise"  # Możesz zmienić na inną, np. "motion_blur"
...
def pick_image(folder: Path) -> Path | None:
    ...
    return paths[14] if paths else None
    ...
    for i, row_items in enumerate(LAYOUT, start=1):
        ...
        for col_idx, name in enumerate(row_items):
            ...
            if name == "clean":
                ...
                folder = CORRUPT_DIR / name / str(SEVERITY) / SYNSET
